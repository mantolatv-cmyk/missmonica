...
export const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    dialogues: [
      { speaker: 'student', english: "Excuse me, I can't find my suitcase. What should I do?", portuguese: "Com licença, não consigo encontrar minha mala. O que devo fazer?" },
      { speaker: 'native', english: "I'm sorry to hear that. You need to go to the Baggage Claim office over there.", portuguese: "Sinto muito por ouvir isso. Você precisa ir ao escritório de Reclamação de Bagagem ali." },
      { speaker: 'student', english: "Okay. Hello, my luggage didn't arrive on flight AA123 from São Paulo.", portuguese: "Ok. Olá, minha bagagem não chegou no voo AA123 de São Paulo." },
      { speaker: 'native', english: "Let me check the system. Can I see your baggage claim tag?", portuguese: "Deixe-me verificar o sistema. Posso ver sua etiqueta de bagagem?" },
      { speaker: 'student', english: "Here it is. It was a large, blue suitcase with a red ribbon.", portuguese: "Aqui está. Era uma mala grande e azul com uma fita vermelha." },
      { speaker: 'native', english: "Thank you. It looks like it was delayed and will be on the next flight.", portuguese: "Obrigado. Parece que ela atrasou e virá no próximo voo." },
      { speaker: 'student', english: "When will it arrive? I need my clothes.", portuguese: "Quando ela vai chegar? Eu preciso das minhas roupas." },
      { speaker: 'native', english: "It should be here this evening. We can deliver it to your hotel for free.", portuguese: "Deve estar aqui hoje à noite. Podemos entregá-la no seu hotel gratuitamente." },
      { speaker: 'student', english: "That would be great. My hotel is the Central Inn in Manhattan.", portuguese: "Isso seria ótimo. Meu hotel é o Central Inn em Manhattan." },
      { speaker: 'native', english: "Please fill out this form with your contact information. We'll call you as soon as it arrives.", portuguese: "Por favor, preencha este formulário com suas informações de contato. Ligaremos assim que chegar." },
      { speaker: 'student', english: "Thank you for your help.", portuguese: "Obrigado pela sua ajuda." },
    ],
    dialoguesBeginner: [
      { speaker: 'student', english: "Excuse me. My bag is missing.", portuguese: "Com licença. Minha mala sumiu." },
      { speaker: 'native', english: "What flight were you on?", portuguese: "Em qual voo você estava?" },
      { speaker: 'student', english: "Flight AA123 from Brazil.", portuguese: "Voo AA123 do Brasil." },
      { speaker: 'native', english: "What color is your bag?", portuguese: "Qual é a cor da sua mala?" },
      { speaker: 'student', english: "It is blue.", portuguese: "Ela é azul." },
      { speaker: 'native', english: "We will find it. Where is your hotel?", portuguese: "Nós vamos encontrá-la. Onde é seu hotel?" },
      { speaker: 'student', english: "Central Inn, Manhattan.", portuguese: "Central Inn, Manhattan." },
      { speaker: 'native', english: "We will deliver it today.", portuguese: "Nós vamos entregá-la hoje." },
