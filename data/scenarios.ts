...
export const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    vocabulary: [
      ...
      { english: "Produce section", portuguese: "Hortifrúti / FLV (Frutas, Legumes e Verduras)" },
      { english: "Bakery", portuguese: "Padaria" },
      { english: "Deli counter", portuguese: "Balcão de frios / Fiambreria" },
      { english: "Dairy section", portuguese: "Setor de laticínios" },
      { english: "Frozen foods aisle", portuguese: "Corredor de congelados" },
      { english: "Meat department / Butcher", portuguese: "Setor de açougue / Carnes" },
      ...
      { english: "Checkout lane / Register", portuguese: "Fila do caixa / Caixa de pagamento" },
      { english: "Cashier", portuguese: "Operador de caixa / Atendente" },
      { english: "Self-checkout", portuguese: "Caixa de autoatendimento" },
      { english: "Receipt", portuguese: "Cupom fiscal / Recibo" },
      { english: "Paper bag / Plastic bag", portuguese: "Sacola de papel / Sacola plástica" },
